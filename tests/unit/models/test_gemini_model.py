...
class TestGeminiModel:
    ...
    async def test_execute_query(self, gemini_model):
        ...
        gemini_model._run_gemini_query = MagicMock(return_value="This is a test response from Gemini")
    ...
    async def test_execute_query_default_model(self, gemini_model):
        ...
        gemini_model._run_gemini_query.assert_called_once_with(prompt, GEMINI_DEFAULT_MODEL)
    ...
    async def test_query_integration(self, gemini_model):
        ...
        gemini_model._execute_query = AsyncMock(return_value="This is a test response from Gemini")
