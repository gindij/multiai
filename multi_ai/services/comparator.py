...
class Comparator:
    ...
    async def compare(
        ...
        successful_responses = [r for r in processed_responses if r.get("success", False)]
    ...
    async def _query_with_fallback(self, provider: str, model: str, prompt: str) -> Dict[str, Any]:
